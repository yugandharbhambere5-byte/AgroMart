    ...
    <section id="about" className="py-24 bg-card transition-colors duration-300 scroll-mt-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20 items-stretch">
          ...
          <div className="p-8 sm:p-10 rounded-3xl bg-earth-100 dark:bg-earth-900/40 border border-border/60 flex flex-col gap-6 relative overflow-hidden group hover:border-red-500/20 transition-colors duration-300">
            ...
            <ul className="flex flex-col gap-4 mt-2">
              {t.about.problems.map((prob, idx) => (
                <li key={idx} className="flex items-start gap-3">
                  <span className="w-6 h-6 rounded-full bg-red-100 dark:bg-red-950/40 text-red-500 flex items-center justify-center font-bold text-sm shrink-0">✕</span>
          ...
          {/* AgroMart Solution */}
          <div className="p-8 sm:p-10 rounded-3xl bg-primary-50/40 dark:bg-primary-950/10 border-2 border-primary-500/20 flex flex-col gap-6 relative overflow-hidden group hover:border-primary-500/40 transition-colors duration-300">
            ...
            <ul className="flex flex-col gap-4 mt-2">
              {t.about.solutions.map((sol, idx) => (
                <li key={idx} className="flex items-start gap-3">
                  <span className="w-6 h-6 rounded-full bg-primary-100 dark:bg-primary-900/60 text-primary-600 dark:text-primary-400 flex items-center justify-center font-bold text-sm shrink-0">✓</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col gap-4 p-6 rounded-2xl border border-border bg-background hover-lift">
